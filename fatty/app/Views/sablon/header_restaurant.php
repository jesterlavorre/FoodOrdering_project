...
<body >
    ...
    <nav class="navbar navbar-expand-sm  bg-dark navbar-light nav-special" >
        <div class="navbar-header">
          <a class="navbar-brand text-warning " href="<?= site_url("Restaurant") ?>">Fatty
        ...
        <div class="collapse navbar-collapse w-100  justify-content-end" id="navbarNavDropdown">
			<ul class="navbar-nav  ">
				<li class="nav-item ">
					<a class="btn btn-warning "  href="<?= site_url("Restaurant/logout") ?>"><i class="fa fa-user"></i> Odjavite se</a>
				</li>
			</ul>
		</div>	
    </nav>
    <nav class="navbar navbar-expand-sm nav2 navbar-light  nav-special" >
        ...
        <div class="collapse navbar-collapse w-100  justify-content-start" id="navbarNavDropdown2">
          <ul class="navbar-nav  ">
        <li class="nav-item ">
        <a class="nav-link" href="<?= site_url("Restaurant/myRestaurant") ?>">  Moj profil</a>       
