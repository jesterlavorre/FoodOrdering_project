...
<div class="container" style="box-shadow: 0 0 20px rgba(0, 0, 0, 0.15);width:40%">
    ...
    <form name="dodajJelo" action="<?= site_url("Restaurant/azurirajJelo/{$jelo->IdJelo}") ?>" method="post" enctype="multipart/form-data">

        <div class="form-group">
            <label for="name">Ime</label>
            <input type="text" class="form-control" name="name"   value="<?= $jelo->Naziv?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="price"   value="<?= $jelo->Cena?>">
        </div>
        ...
        <div class="form-group">
            <label for="ingredient">Sastojci</label>
             <input type="text" class="form-control" name="ingredient"  value="<?= $jelo->Sastojci?>">
        </div>
        ...
        <center>
            <button class="btn btn-warning">Azuriraj jelo</button>
        </center>
    </form>
        </div>
</div>